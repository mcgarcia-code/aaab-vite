<template>
  ...
  <div class="container-fluid py-4 animate__animated animate__fadeIn">
    ...
    <div class="text-center mb-4">
      <i class="bi bi-eye main-icon" style="font-size: 3.5rem; color: #dc2626;"></i> 
      <h2 class="fw-bold text-white mt-2">Observación Arbitral</h2>
      <p class="small text-white m-0 opacity-75">Seguimiento y evaluación de desempeño arbitral</p>
    </div>
    ...
    <main class="sacf-content">
      ...
      <form v-else @submit.prevent="enviarFormulario">
        ...
        <footer class="form-actions p-4 bg-white text-center">
          <button type="submit" class="sacf-btn btn-danger py-3 shadow-lg" :disabled="procesando">
...
.btn-danger:hover:not(:disabled) { background: #b91c1c; transform: translateY(-3px); box-shadow: 0 10px 20px rgba(220, 38, 38, 0.3); }
...
.icon-check { font-size: 5rem; filter: drop-shadow(0 10px 15px rgba(0,0,0,0.1)); }
</style>
