<template>
  <div class="container-fluid py-0 animate__animated animate__fadeIn">
    ...
    <!-- Manejo de margen inferior responsivo con mb-4 y mb-md-5 -->
    <div class="dashboard-header mb-4 mb-md-5 mt-4 text-start">
      <div class="d-flex align-items-center justify-content-start gap-3">
        ...
        <div>
          ...
          <p class="text-white opacity-75 m-0" style="font-size: 0.85rem;">Registrar cobro de cuotas y aportes mensuales.</p>
        </div>
      </div>
    </div>

    <div class="row g-3 g-md-4">
      <div v-for="item in opcionesPagosAportes" :key="item.title" class="col-12 col-md-4">
...
useHead({
  ...
  meta: [
    { name: 'description', content: 'Gestiona los aportes y pagos de los miembros de la asociación.' },
...
const opcionesPagosAportes = [
  {
    to: '/panel-admin/tesoreria/aportes',
    title: 'Aportes Mensuales',
    icon: 'bi bi-cash-coin',
    desc: 'Registrar cobros y aportes mensuales de los Árbitro'
  },
    {
    to: '/panel-admin/pagos-curso',
    title: 'Pagos del Curso de Árbitros',
    icon: 'bi bi-cash-coin',
    desc: 'Registrar cobros de cuotas del Curso de Árbitros'
  },
];
</script>
