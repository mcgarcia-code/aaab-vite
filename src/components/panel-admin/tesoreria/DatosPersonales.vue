...
const cargarDatos = async () => {
  try {
    ...
    if (payload) listaCompleta.value = payload;
...
.table-container { 
  width: 100%; overflow: auto; max-height: 80vh; 
...
/* Ajuste para que los filtros de las columnas fijas no se muevan al hacer scroll horizontal */
