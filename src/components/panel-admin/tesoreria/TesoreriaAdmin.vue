  ...
  <div class="container py-4 animate__animated animate__fadeIn">
    ...
    <div class="dashboard-header mb-5 text-center text-md-start">
      <div class="d-flex align-items-center justify-content-center justify-content-md-start gap-3">
        ...
        <div>
          <h2 class="fw-bold text-white m-0">Tesorería</h2>
          <p class="small text-white opacity-75 m-0">Gestión contable y control de recursos de la asociación</p>
        </div>
      </div>
    </div>
    ...
    <div class="row g-3 g-md-4 justify-content-center">
      <div v-for="item in opcionesTesoreria" :key="item.title" class="col-12 col-md-6 col-xl-4">
