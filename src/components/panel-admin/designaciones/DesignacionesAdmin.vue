    ...
    <div class="dashboard-header mb-4 mb-md-5 mt-4 text-start">
      <div class="d-flex align-items-center justify-content-start gap-3">
        <div class="main-icon-container flex-shrink-0">
          <i class="bi bi-calendar4-week text-danger"></i>
        </div>
        <div>
          <!-- Tipografía adaptativa para el título -->
          <h4 class="fw-bold text-white m-0 fs-5 fs-md-4">Designaciones</h4>
          <p class="text-white opacity-75 m-0" style="font-size: 0.85rem;">Disponibilidad, partidos y licencias</p>
        </div>
      </div>
    </div>
...
useHead({
  ...
  meta: [
    { name: 'description', content: 'Gestión de disponibilidad y licencias.' }
  ],
});
...
/* El tamaño del ícono escala automáticamente gracias a clamp() */
.icon-box {
...
/* Eliminamos todas las @media queries, la disposición es 100% Bootstrap nativo. */
</style>
