  ...
  <div class="container py-4 animate__animated animate__fadeIn">
    ...
    <div class="dashboard-header mb-5 text-center text-md-start">
      <div class="d-flex align-items-center justify-content-center justify-content-md-start gap-3">
        ...
        <div>
          <h2 class="fw-bold text-white m-0">Observaciones</h2>
    ...
    <div class="row g-3 g-md-4 justify-content-center">
      <div v-for="item in opcionesObservaciones" :key="item.title" class="col-12 col-md-6 col-xl-5">
...
useHead({
  ...
  meta: [
    { name: 'description', content: 'Módulo para cargar y visualizar observaciones sobre los árbitros.' },
    { property: 'og:title', content: 'Observaciones | AAAB' },
...
const opcionesObservaciones = [
  { 
    ...
    desc: 'Registrar nuevas evaluaciones con detalles y categorías específicas.' 
  },
  { 
