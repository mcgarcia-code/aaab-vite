      ...
      <div class="card shadow border-0 w-100 mx-auto bg-white mb-4" style="border-radius: 12px; overflow: hidden;">
        ...
        <div class="card-header bg-white py-3 d-flex flex-column flex-md-row justify-content-between align-items-md-center border-bottom gap-3">
          <div class="border-start border-danger border-5 ps-3">
            ...
            <span class="text-muted small d-block mt-1">Asambleas y Recuperatorios — Mi grupo · {{ totalFiltrados }} árbitros</span>
          </div>
          ...
          <div v-if="formExamen.asistencia === 'presente'" class="col-12 mt-3 animate__animated animate__fadeIn">
            ...
            <div v-for="(detalle, index) in formExamen.detalles" :key="index"
              ...
              <div class="col-md-4">
                ...
                <select v-model="detalle.tipo" class="form-select form-select-sm shadow-none border-secondary-subtle" required>
                  <option value="">Seleccionar...</option>
                  <option v-for="s in TIPOS_EVALUACION" :key="s" :value="s">{{ s.toUpperCase() }}</option>
                </select>
              </div>
              <div class="col-md-3">
...
useHead({
  title: 'Exámenes | Coordinador',
  meta: [{ name: 'description', content: 'Gestión de exámenes del grupo coordinado.' }],
})
