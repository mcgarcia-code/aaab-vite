        ...
        <aside class="sidebar-professional shadow-sm mb-3 mb-lg-0 sticky-lg-top" style="top: 20px; z-index: 10;">
          <div class="sidebar-header">
            <div class="d-flex align-items-center">
              ...
              <span class="fw-black ls-1 text-uppercase">Avisos del Curso</span>
            </div>
          ...
          <div class="sidebar-scroll-container p-2 p-lg-3 overflow-auto" style="max-height: calc(100vh - 100px);">
            ...
            <div class="notif-section mb-2 mb-lg-3 pb-2 pb-lg-3">
              ...
              <div v-show="seccionesAbiertas.reuniones" class="collapse-content animate__animated animate__fadeIn">
                ...
                <p v-else class="empty-msg">No hay clases o eventos próximos.</p>
              </div>
            </div>
...
// --- MENÚ DINÁMICO ADAPTADO AL CURSO ---
const menuItems = [
  { to: '/panel-curso/datos-curso', title: 'Datos Personales', icon: 'bi bi-person-lines-fill', desc: 'Ver tu legajo y perfil.' },
  { to: '/panel-curso/credencial-curso', title: 'Credencial Digital', icon: 'bi bi-person-badge', desc: 'Carnet de aspirante 2026.' },
  { to: '/panel-curso/rendimiento-curso', title: 'Mi Rendimiento', icon: 'bi bi-graph-up-arrow', desc: 'Asistencia y exámenes.' },
  { to: '/panel-curso/cuota-curso', title: 'Cuota del Curso', icon: 'bi bi-cash-coin', desc: 'Gestión de pagos.' }
];
